...
const words={
    ...
    // "ramos" , "ineista" , "marcelo" ,"koke","morata","kante","sancho","sterling","lukaku","jesuss"],
    ...
    wardat : ["momen","moghrabi","naqshi","mokresh","ali","rawan","shalabi","yahya","dadikhy","tamim","fayyad"],
};
//get random property
